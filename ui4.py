...
#
# Created: Fri May 01 16:17:41 2015
...
class Ui_loaderWindow(object):
    def setupUi(self, loaderWindow):
        ...
        self.loadLevel_comboBox = QtGui.QComboBox(self.frame_2)
        self.loadLevel_comboBox.setObjectName("loadLevel_comboBox")
        self.horizontalLayout_4.addWidget(self.loadLevel_comboBox)
        ...
        self.info2_label.setMaximumSize(QtCore.QSize(16777215, 16))
        font = QtGui.QFont()
        font.setWeight(75)
        font.setBold(True)
        ...
        self.email_pushButton.setMinimumSize(QtCore.QSize(0, 26))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(222, 216, 42))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        ...
        self.email_pushButton.setPalette(palette)
    ...
    def retranslateUi(self, loaderWindow):
        ...
        self.label_6.setText(QtGui.QApplication.translate("loaderWindow", "Load Level : ", None, QtGui.QApplication.UnicodeUTF8))
